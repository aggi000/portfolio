import { mergeProps, useSSRContext, reactive, ref, computed, withCtx, createVNode, toDisplayString, unref, nextTick } from "vue";
...
import { _ as __nuxt_component_0 } from "./nuxt-link-BsfybM0k.js";
...
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.project.tags?.length) {
      ...
      if (__props.project.points?.length) {
...
const _imports_0 = "" + __buildAssetsURL("pic.QUfEl8E8.jpeg");
const resumeUrl = "" + __buildAssetsURL("resume.DJKr-Yn7.pdf");
const _sfc_main$1 = {
  __name: "StickyHero",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function onToggle(id) {
      ...
      moveToTop(id);
      nextTick(() => {
        (void 0).querySelector("#projects")?.scrollIntoView({ behavior: "smooth", block: "start" });
      });
    }
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=index-nMkNIx96.js.map
